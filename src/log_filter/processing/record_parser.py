...
class StreamingRecordParser:
    ...
    def __init__(
        ...
        """
        self.record_start_pattern = (
            record_start_pattern or self.DEFAULT_RECORD_START_PATTERN
        )
    ...
    def parse_lines(
        ...
        for line in lines:
            ...
            if match:
                ...
                # Check size limit
                if (self.max_record_size_bytes and 
                    current_size_bytes > self.max_record_size_bytes):
