...
def sample_config():
    ...
    return ApplicationConfig(
        ...
        output=OutputConfig(
            output_file=Path("output.log"), highlight_matches=False, include_file_path=True
        ),
...
class TestFileWorkerInitialization:
    ...
    def test_init_with_all_dependencies(
        self, mock_handler_factory, mock_record_parser, mock_record_filter, mock_stats_collector
    ):
...
class TestFileValidation:
    ...
    def test_process_file_with_invalid_file(
        self, file_worker, sample_file_meta, sample_config, mock_writer, mock_handler_factory
    ):
    ...
    def test_process_file_with_valid_file(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
...
class TestRecordProcessing:
    ...
    def test_process_file_counts_records(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_respects_filter(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_with_matching_record(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_with_non_matching_record(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
...
class TestHighlighting:
    ...
    def test_process_file_with_highlighting_enabled(
        self,
        file_worker,
        sample_file_meta,
        mock_writer,
        ...
        config = ApplicationConfig(
            search=SearchConfig(expression="ERROR"), output=OutputConfig(highlight_matches=True)
        )
    ...
    def test_process_file_without_highlighting(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
...
class TestErrorHandling:
    ...
    def test_process_file_handles_record_size_exceeded(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
        ...
        assert matches == 0
        file_worker.stats_collector.increment_files_skipped.assert_called_with(
            "record-size-exceeded"
        )

    def test_process_file_handles_file_handling_error(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_handles_unexpected_error(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_continues_after_partial_matches(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
...
class TestRegexMode:
    ...
    def test_process_file_with_regex_enabled(
        self,
        file_worker,
        sample_file_meta,
        mock_writer,
        ...
        config = ApplicationConfig(
            search=SearchConfig(expression="ERROR.*failed", use_regex=True), output=OutputConfig()
        )
    ...
    def test_process_file_with_case_insensitive(
        self,
        file_worker,
        sample_file_meta,
        mock_writer,
        ...
        config = ApplicationConfig(
            search=SearchConfig(expression="error", ignore_case=True), output=OutputConfig()
        )
...
class TestMultipleRecords:
    ...
    def test_process_file_with_multiple_matching_records(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
    ...
    def test_process_file_with_mixed_records(
        self,
        file_worker,
        sample_file_meta,
        sample_config,
