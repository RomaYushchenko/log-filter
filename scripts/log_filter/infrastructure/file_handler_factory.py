...
class FileHandlerFactory:
    ...
    def create_handler(
        self, file_path: Path, encoding: Optional[str] = None, errors: Optional[str] = None
    ) -> AbstractFileHandler:
        ...
        if not file_path.exists():
            raise FileHandlingError(f"File not found: {file_path}", file_path=file_path)
    ...
    def __repr__(self) -> str:
        ...
        return f"FileHandlerFactory(encoding={self.encoding}, " f"errors={self.errors})"
